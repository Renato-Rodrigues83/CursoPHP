...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        'idClientes' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'phone' => 'Lorem ipsum d',
                'created' => '2022-10-22 19:19:13',
                'modified' => '2022-10-22 19:19:13',
            ],
        ];
        parent::init();
    }
